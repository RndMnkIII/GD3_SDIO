...
{
 while(1) {
//   GD.ClearColorRGB(0x00ff00);  //fondo uniforme            
   GD.Clear();      
   GD.cmd_gradient(0, 0, 0x00ff00, 0, 271, 0xc060000);     
   GD.get_inputs();
  ...
  GD.RestoreContext();  
   ...
   GD.Tag(8); GD.cmd_button(352, 12, 40, 30, 28, 0,  "MP");  GD.Tag(255);
    if (GD.inputs.tag==8){
        delay(145);
...
{
 while(1) {
   GD.ClearColorRGB(0x001025);  //fondo uniforme      
   GD.Clear(); //  GD.cmd_gradient(0, 0, 0x001025, 0, 271, 0xc060000);   
   GD.get_inputs();
